...
function imsiMarkup(){
    var a = "       <table class=\"sonDualEditor\" >"+
    "            <thead>"+
    "            <tr>"+
    "                <th colspan=\"2\">"+
    "                    <div class=\"btn-toolbar\" id=\"btnToolbar\">"+
    "                        <div class=\"btn-group\">"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm dropdown-toggle\" data-toggle=\"dropdown\"><i class=\"fa fa-font\"></i><span class=\"caret\"></span></button>"+
    ...
    "                        </div>"+
    "                        <div class=\"btn-group\">"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm dropdown-toggle\" data-toggle=\"dropdown\"><i class=\"fa fa-text-height\"></i><span class=\"caret\"></span></button>"+
    "                            <ul class=\"dropdown-menu\" role=\"menu\">"+
    "                                <li>"+
    ...
    "                        </div>"+
    "                        <div class=\"btn-group\">"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm dropdown-toggle\" data-toggle=\"dropdown\"><i class=\"fa fa-header\"></i><span class=\"caret\"></span></button>"+
    "                            <ul class=\"dropdown-menu\" role=\"menu\">"+
    "                                <li>"+
    ...
    "                        </div>"+
    "                        <div class=\"btn-group\">"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm dropdown-toggle\" data-toggle=\"dropdown\" data-mode=\"color\" data-before=\"color\" data-center=\" \" data-after=\"color\"><i class=\"fa fa-barcode\"></i><span class=\"caret\"></span></button>"+
    "                        </div>"+
    "                        <div class=\"btn-group\">"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"**\" data-center=\" \" data-after=\"**\"><i class=\"fa fa-bold\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"_\" data-center=\" \" data-after=\"_\"><i class=\"fa fa-italic\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"//\" data-center=\" \" data-after=\"//\"><i class=\"fa fa-underline\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"[d]\" data-center=\" \" data-after=\"[d]\"><i class=\"fa fa-strikethrough\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"[sb]\" data-center=\" \" data-after=\"[sb]\"><i class=\"fa fa-subscript\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"[sp]\" data-center=\" \" data-after=\"[sp]\"><i class=\"fa fa-superscript\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"[align:left]\" data-center=\" \" data-after=\"[align]\"><i class=\"fa fa-align-left\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"[align:center]\" data-center=\" \" data-after=\"[align]\"><i class=\"fa fa-align-center\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"[align:right]\" data-center=\" \" data-after=\"[align]\"><i class=\"fa fa-align-right\"></i></button>"+
    "                        </div>"+
    "                        <div class=\"btn-group\">"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"insert\" data-before=\"***\" data-center=\"\" data-after=\"\"><i class=\"glyphicon glyphicon-minus\"></i></button>"+
    "                        </div>"+
    "                        <div class=\"btn-group\">"+
    "                        </div>"+
    "                        <div class=\"btn-group\">"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"* \" data-center=\" \" data-after=\"\"><i class=\"fa fa-list-ul\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"1. \" data-center=\" \" data-after=\"\"><i class=\"fa fa-list-ol\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"[syntax]\" data-center=\"\"  data-after=\"[syntax]\"><i class=\"fa fa-code\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-toggle=\"modal\" data-target=\"#tableModal\" data-mode=\"layer\" data-type=\"table\"><i class=\"fa fa-table\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"[field|타이틀]\" data-center=\"\"  data-after=\"[field]\"><i class=\"fa fa-credit-card\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-toggle=\"modal\" data-target=\"#urlModal\" data-mode=\"layer\" data-type=\"url\" ><i class=\"fa fa-link\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-toggle=\"modal\" data-target=\"#imgModal\" data-mode=\"layer\" data-type=\"img\" ><i class=\"fa fa-file-image-o\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\" data-before=\"[alert]\" data-center=\" \" data-after=\"[alert]\"><i class=\"fa fa-exclamation-triangle\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" data-mode=\"append\"  data-before=\"[info]\"  data-center=\" \"  data-after=\"[info]\"><i class=\"fa fa-info\"></i></button>"+
    "                            <button type=\"button\" class=\"sonwiki-btn btn btn-default btn-sm\" ><i class=\"fa fa-lightbulb-o\"></i></button>"+
    "                        </div>"+
    "                    </div>"+
    "                </th>"+
    "            </tr>"+
    ...
    "            <tbody>"+
    "            <tr>"+
    "                <td style=\"width: 50%; padding-top: 0px;padding-left: 0px;\">"+
    "                    <textarea class=\"sonjs form-control\" rows=\"20\" id=\"wikiEditor\" name=\"we_wiki_text\" style=\"overflow: scroll; height: 900px;\"></textarea>"+
    "                </td>"+
    "                <td style=\"width: 50%; padding-top: 10px;padding-left: 10px;\">"+
    "                    <div id=\"wikimaincol\" style=\"border: 1px; overflow: scroll; height: 900px;\">"+
    "                    </div>"+
    "                </td>"+
    "            </tr>"+
    "            </tbody>"+
