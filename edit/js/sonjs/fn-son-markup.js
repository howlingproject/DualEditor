...
var SONJS = (function(){
    ...
    SONJS.setting = function(tarket,type){
        SONJS.append(sEditorPath);
        if( type == "mini"){
        	tarket.append(getMarkupEditMiniHtml());
        }else{
        	tarket.append(getMarkupEditHtml());	
        }
