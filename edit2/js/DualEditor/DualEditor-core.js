var DualEditor = (function(){
    ...
    DualEditor.setting = function(params){
        ...
        $(".sonDualEditor tbody tr :first").attr("style", "width:"+screenWidth+"px;");
        $(".sonDualEditor tbody tr :first > td").attr("style", "width:"+screenWidth/2+"px;");
